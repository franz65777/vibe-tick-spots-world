...
const promptToOsmQuery: Record<NearbyPrompt, string> = {
  ...
  entertainment: '["amenity"~"cinema|theatre|casino|amusement_arcade"]',
  park: '["leisure"~"park|garden|playground|nature_reserve"]',
  historical: '["tourism"~"attraction|monument|memorial"]["historic"]',
  nightclub: '["amenity"~"nightclub|discotheque"]',
  // Subcategories
