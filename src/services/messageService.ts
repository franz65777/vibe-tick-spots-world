...
export interface DirectMessage {
  ...
  receiver_id: string;
  content?: string;
  message_type: 'text' | 'place_share' | 'trip_share' | 'post_share' | 'profile_share' | 'audio' | 'story_reply' | 'story_share' | 'folder_share';
  shared_content?: any;
  created_at: string;
  read_at?: string;
  is_read: boolean;
    ...
    try {
      ...
      return (messages || []).map((message) => {
        ...
        const result: DirectMessage = {
          ...
          message_type: message.message_type as 'text' | 'place_share' | 'trip_share' | 'post_share' | 'profile_share' | 'audio' | 'story_reply' | 'story_share' | 'folder_share',
