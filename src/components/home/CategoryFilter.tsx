  ...
  return (
    <div className="relative flex-shrink-0">
      ...
      >
        ...
        {selectedCount > 0 && (
          <span className="bg-white text-blue-600 px-1.5 py-0.5 rounded-full text-xs font-bold min-w-[18px] text-center">
            {selectedCount}
          </span>
        )}
      </button>
      ...
      {isOpen && (
        <>
          ...
          <div className="absolute top-full right-0 mt-2 w-64 sm:w-72 bg-white rounded-xl shadow-lg border border-gray-200 z-50 overflow-hidden">
            {/* Header */}
