...
import filterAllFriendsIcon from '@/assets/no-users-character.png';
...
const ListDrawerSubFilters: React.FC<ListDrawerSubFiltersProps> = ({
  ...
  if (activeFilter === 'following') {
    ...
    return (
      <div className="px-4">
        <div className="flex items-center gap-2 overflow-x-auto overflow-y-visible scrollbar-hide py-1.5 pl-0.5">
