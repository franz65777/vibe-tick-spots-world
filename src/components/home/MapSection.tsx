        ...
        <div 
          ...
          <Sheet open={isListViewOpen} onOpenChange={setIsListViewOpen}>
            <SheetTrigger asChild>
              <button
                className="rounded-[18px] bg-background/80 backdrop-blur-md border border-border/20 shadow-lg hover:bg-background/90 hover:scale-105 w-11 h-14 transition-all flex items-center justify-center"
              >
