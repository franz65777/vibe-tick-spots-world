        ...
        <div 
          ...
          <Sheet open={isListViewOpen} onOpenChange={setIsListViewOpen}>
            <SheetTrigger asChild>
              <button
                className="rounded-full bg-gray-200/40 dark:bg-slate-800/65 backdrop-blur-md border border-primary/30 shadow-lg hover:bg-gray-300/50 dark:hover:bg-slate-700/70 hover:scale-105 w-11 h-11 transition-all flex items-center justify-center"
              >
