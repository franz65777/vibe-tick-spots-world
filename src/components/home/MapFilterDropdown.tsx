...
const MapFilterDropdown = () => {
  ...
  return (
    <div ref={containerRef} className="relative flex items-center">
      {/* Friends selection dropdown - opens downward */}
      {isFriendsDropdownOpen && activeFilter === 'following' && (
        <div className="absolute top-full left-0 mt-2 bg-gray-200/40 dark:bg-slate-800/65 backdrop-blur-md rounded-2xl border border-border/30 shadow-lg min-w-[320px] max-h-[300px] z-50">
