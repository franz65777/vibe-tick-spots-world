...
const ProfileTabs = ({
  ...
  return (
    <div className="px-3 mb-4">
      <div className="flex bg-gray-100/60 dark:bg-slate-800/50 backdrop-blur-md rounded-xl p-1 shadow-inner border border-gray-200/50 dark:border-white/5">
        <button
          onClick={() => onTabChange('posts')}
          className={cn(
            "flex-1 py-2 px-2.5 rounded-lg text-sm font-medium transition-all duration-200 flex items-center justify-center gap-1.5",
            activeTab === 'posts'
              ? "bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-md shadow-blue-500/25 scale-[1.02]"
        ...
        <button
          ...
          className={cn(
            "relative flex-1 py-2 px-2.5 rounded-lg text-sm font-medium transition-all duration-200 flex items-center justify-center gap-1.5",
            activeTab === 'badges'
              ? "bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-md shadow-blue-500/25 scale-[1.02]"
              : "text-muted-foreground hover:bg-white/50 dark:hover:bg-white/10"
          )}
