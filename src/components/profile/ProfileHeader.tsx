            ...
            <div className="flex items-center gap-3 mb-3 sm:mb-2">
              <div className="flex items-center gap-2">
                ...
                {profile?.is_business_user && (
                  <Button size="sm" className="bg-green-500 hover:bg-green-600 text-white text-sm sm:text-xs px-4 py-2 sm:px-3 sm:py-1 rounded-full min-h-[32px] sm:min-h-[28px]">
                    Business
                  </Button>
                )}
              </div>
