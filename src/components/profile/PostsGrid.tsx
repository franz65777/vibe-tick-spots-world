...
const PostsGrid = ({ userId, locationId, contentTypes, excludeUserId }: PostsGridProps) => {
  ...
  return (
    <div className="px-4 overscroll-contain">
      ...
      <div className="sticky top-0 z-20 -mx-4 px-4 pb-2 pt-1 bg-[#F5F1EA] dark:bg-zinc-900 rounded-b-2xl">
              ...
              <div className="flex gap-2 pr-4">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    !selectedCity
                      ? "bg-black text-white"
                      : "bg-white/80 dark:bg-white/15 text-gray-600 shadow-sm backdrop-blur-sm border border-white/50"
                  )}
                >
