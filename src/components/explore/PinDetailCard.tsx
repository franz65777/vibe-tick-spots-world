            ...
            <>
              ...
              >
                <button
                  ...
                  className="w-full flex items-center gap-3 py-2 px-3 rounded-2xl border-2 border-dashed border-border/60 bg-muted/30 hover:bg-muted/50 transition-colors"
                >
                  ...
                  <span className="flex-1 text-sm text-muted-foreground font-medium text-left">
                    {t('whatDidYouThink', { ns: 'explore', defaultValue: 'cosa ne pensi??' })}
                  </span>
