  ...
  return (
    <div className="h-screen flex flex-col bg-background">
      ...
      <div className="flex items-center gap-3 p-4 pt-[env(safe-area-inset-top)] sticky top-0 z-10 bg-background">
        ...
        <img src={privacyIcon} alt="" className="w-8 h-8 object-contain" />
        <h1 className="text-xl font-bold">{t('privacy', { ns: 'settings', defaultValue: 'Privacy' })}</h1>
      </div>
            ...
            <div className="space-y-3 pt-4 border-t">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">
                    {t('beenCardsVisibilityDesc', { ns: 'settings', defaultValue: 'Who can see your visited places in the feed' })}
                  </div>
                </div>
              </div>
